...
namespace FMITerminalBlock 
{
	namespace Network
	{
		...
		public:
			...
			/** @brief The tag number without any flags of the IEC 61499 type */
			static const uint8_t SINT_TAG_NR = 2;
			/** @brief The tag number without any flags of the IEC 61499 type */
			static const uint8_t INT_TAG_NR = 3;
			/** @brief The tag number without any flags of the IEC 61499 type */
			static const uint8_t DINT_TAG_NR = 4;
			/** @brief The tag number without any flags of the IEC 61499 type */
			static const uint8_t LINT_TAG_NR = 5;
			/** @brief The tag number without any flags of the IEC 61499 type */
			static const uint8_t USINT_TAG_NR = 6;
			/** @brief The tag number without any flags of the IEC 61499 type */
			static const uint8_t UINT_TAG_NR = 7;
			/** @brief The tag number without any flags of the IEC 61499 type */
			static const uint8_t UDINT_TAG_NR = 8;
			/** @brief The tag number without any flags of the IEC 61499 type */
			static const uint8_t ULINT_TAG_NR = 9;
			/** @brief The tag number without any flags of the IEC 61499 type */
