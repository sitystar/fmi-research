...
void Tank_function_initSynchronous(DATA *data, threadData_t *threadData)
{
...
/* Update base-clock. */
void Tank_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
...
int Tank_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  int ret;
...
/* %v% = pre(%v%)*/
void Tank_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
}
