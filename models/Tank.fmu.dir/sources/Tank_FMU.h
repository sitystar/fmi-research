...
#define MODEL_GUID "{ec9d72ef-f13b-40d5-84fa-1f6d0ff4aaee}"
...
extern void Tank_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc Tank_setupDataStruc
#include "fmi-export/fmu2_model_interface.h"
#include "fmi-export/fmu_read_flags.h"

#define FMI2_FUNCTION_PREFIX Tank_
